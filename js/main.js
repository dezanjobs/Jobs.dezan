...
const translations = {
    ...
    EN: {
        ...
        jobs: [
            ...
            { year: "04 Apr 2016 - 25 Feb 2020", title: "Datacenter Specialist", comp: "PT. ValueStream International", desc: "- Conducted preventive maintenance of Data Center infrastructure, increasing equipment reliability by 25% and reducing operational disruptions.<br/>- Managed installation and commissioning of 30+ new rack positions, enabling faster deployment of server infrastructure.<br/>- Monitored and analyzed environmental conditions, such as power usage and temperature, to ensure optimal equipment performance.<br/>- Installed and repaired critical hardware components, including routers, switches, and modems, ensuring robust network connectivity.<br/>- Supported production server applications with consistent service delivery and minimal downtime." },
            { year: "01 Jan 2015 - 31 Mar 2016", title: "Wi-Fi Support Engineer", comp: "Indosat Coop", desc: "- Installed and configured radio systems, routers, and access points, enabling enhanced Wi-Fi coverage.<br/>- Performed network installations and troubleshooting, increasing network reliability." },
            { year: "01 Oct 2012 - 31 Dec 2014", title: "Technical Support", comp: "PT. Personil Alih Daya", desc: "- Installed and configured radio systems, routers, and access points for enterprise clients.<br/>- Conducted comprehensive network troubleshooting and maintenance." },
			{ year: "1 Jul 2011 - 31 Aug 2011", title: "Interm", comp: "CV. Media Utama Computer", desc: "- Provided computer technical support, including hardware and software maintenance." },
			{ year: "1 Jun 2011 - 30 Jun 2011", title: "Interm", comp: "PT. Securindo Packatama Indonesia", desc: "- Assisted with computer technical support and system troubleshooting." }
        ],
        school: [
    ...
    ZH: {
        ...
        jobs: [
			...
			{ year: "2012年10月1日 - 2014年12月31日", title: "技術支援", comp: "PT. Personil Alih Daya", desc: "- 為企業客戶安裝與設定無線電系統、路由器與無線基地台。<br/>- 執行完整的網路故障排除與維護作業。" },
    ...
    JP: {
        ...
        jobs: [
			...
			{ year: "2012年10月1日 - 2014年12月31日", title: "テクニカルサポート", comp: "PT. Personil Alih Daya", desc: "- 企業向けに無線通信システム、ルーター、アクセスポイントの設置および設定を実施。<br/>- ネットワークの総合的なトラブルシューティングおよび保守を担当。" },
    ...
    KO: {
        ...
        jobs: [
			...
			{ year: "2012년 10월 1일 - 2014년 12월 31일", title: "기술 지원", comp: "PT. Personil Alih Daya", desc: "- 기업 고객을 대상으로 무선 통신 시스템, 라우터 및 액세스 포인트 설치 및 구성을 수행함.<br/>- 네트워크 전반에 대한 장애 분석 및 유지보수를 담당함." },
    ...
    DE: {
        ...
        jobs: [
			...
			{ year: "1. Oktober 2012 - 31. Dezember 2014", title: "Technischer Support", comp: "PT. Personil Alih Daya", desc: "- Installation und Konfiguration von Funksystemen, Routern und Access Points für Unternehmenskunden.<br/>- Durchführung umfassender Netzwerk-Fehlerbehebung und Wartung." },
    ...
    ES: {
        ...
        jobs: [
			...
			{ year: "1 de octubre de 2012 - 31 de diciembre de 2014", title: "Soporte Técnico", comp: "PT. Personil Alih Daya", desc: "- Instalación y configuración de sistemas de radio, routers y puntos de acceso para clientes empresariales.<br/>- Realización de mantenimiento y resolución integral de problemas de red." },
    ...
    PT: {
        ...
        jobs: [
			...
			{ year: "1 de outubro de 2012 - 31 de dezembro de 2014", title: "Suporte Técnico", comp: "PT. Personil Alih Daya", desc: "- Instalação e configuração de sistemas de rádio, roteadores e pontos de acesso para clientes corporativos.<br/>- Execução de manutenção e troubleshooting completo de rede." },
    ...
    RU: {
        ...
        jobs: [
			...
			{ year: "1 октября 2012 - 31 декабря 2014", title: "Техническая поддержка", comp: "PT. Personil Alih Daya", desc: "- Установка и настройка радиосистем, маршрутизаторов и точек доступа для корпоративных клиентов.<br/>- Проведение комплексного обслуживания и устранения сетевых неисправностей." },
    ...
    NL: {
        ...
        jobs: [
			...
			{ year: "1 oktober 2012 - 31 december 2014", title: "Technische ondersteuning", comp: "PT. Personil Alih Daya", desc: "- Installatie en configuratie van radiosystemen, routers en access points voor zakelijke klanten.<br/>- Uitvoering van uitgebreide netwerkproblemenanalyse en onderhoud." },
    ...
    IT: {
        ...
        jobs: [
			...
			{ year: "1 ottobre 2012 - 31 dicembre 2014", title: "Supporto Tecnico", comp: "PT. Personil Alih Daya", desc: "- Installazione e configurazione di sistemi radio, router e access point per clienti aziendali.<br/>- Esecuzione di manutenzione e troubleshooting di rete completi." },
    ...
    AR: {
        ...
        jobs: [
			...
			{ year: "1 أكتوبر 2012 - 31 ديسمبر 2014", title: "الدعم الفني", comp: "PT. Personil Alih Daya", desc: "- تركيب وتهيئة أنظمة الراديو وأجهزة التوجيه ونقاط الوصول لعملاء الشركات.<br/>- تنفيذ أعمال الصيانة الشاملة واستكشاف أخطاء الشبكة." },
